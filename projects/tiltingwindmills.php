...
<h1 class="centered">Tilting At Windmills</h1>

<iframe class="banner" width="600" height="338" src="//www.youtube.com/embed/I4FHmsjQyGI?rel=0" frameborder="0" allowfullscreen></iframe>
...
<div id="contribTable">
    ...
    <div class="projectRow">
        <div class="projectCell">
            ...
            <p>As one of the main programmers on the project, I worked on various portions of the code such as the controls, projectiles, rotation and animation of the characters, and audio.</p>
        </div>
        <div class="projectCell">
            <h3 class="centered">Design</h3>
            <p>The whole team shared the role of design - from the creation of the original game idea, the general game design and stylistic choices.</p>
        </div>
    </div>
</div>

<h3 class="centered"><a href="http://globalgamejam.org/2014/games/tilting-windmills" target="_blank">Visit the Global Game Project Page</a></h3>
