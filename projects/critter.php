...
<div id="contribTable">
    ...
    <div class="projectRow">
        <div class="projectCell">
            ...
            <p>I created this game in 48 hours together with two other programmers. I created much of the game mechanics, including the turning and clicking mechanism, as well implementing many of the graphics.</p>
        </div>
        <div class="projectCell">
            <h3 class="centered">Design</h3>
            <p>Game design was done by all group members and I contributed largely to the idea of the overall game mechanic. The team also collaboratively decides on UI and feedback display designs.</p>
        </div>
    </div>
</div>
