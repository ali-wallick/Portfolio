...
<div id="contribTable">
    <div class="projectRow">
        ...
        <div class="projectCell">
            <img class="projectTableImage" src="/resources/images/projects/minimages/design.png" />
        </div>
    </div>
    <div class="projectRow">
        <div class="projectCell">
            <h3 class="centered">Programming</h3>
            <p>As a programmer, I created most of the elements for the "non-game" scenes/components - including creating the connection scene, overworld, and win scene. This also included adding scoring into each of the games and displaying player's details on their screens, creating a system for round-robin game picking, animating a win state and integrating much of the UI throughout the game.</p>
        </div>
        <div class="projectCell">
            <h3 class="centered">Design</h3>
            <p>My main role for the project was to lead the design process by making final decisions on the flow and style of our game. Game design was a group process that involved the creation of the overall game idea to fit our client's expectations (a 4-player concept game connecting the iPhone and iPad), as well as the individual mini-games (each of which was made to showcase the abilities of the iPhone/iPad).</p>
        </div>
    </div>
</div>
