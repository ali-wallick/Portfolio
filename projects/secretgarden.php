...
<h1 class="centered">Secret Garden</h1>

<iframe class="banner" width="600" height="371" src="http://www.youtube.com/embed/OHjZMJ68UjI" frameborder="0" allowfullscreen></iframe>
...
<div id="contribTable">
    ...
    <div class="projectRow">
        <div class="projectCell">
            ...
            <p>Programming Secret Garden was done by Robert and myself. Personally, I took on the grid/node system of the game as well as the automatic movement of the girl. I also implemented the Qualcomm AR plugin, and imported and connected the graphics made by our artist, Rose.</p>
        </div>
        <div class="projectCell">
            <h3 class="centered">Design</h3>
            <p>The game design was created collaboratively by all group members. Together we created the central mechanic, as well as the varieties of enemies and plants, and the secondary goal system. I designed the level currently in the game, and future levels are expected to be implemented.</p>
        </div>
    </div>
</div>

<h3 class="centered"><a href="http://www.argamestudio.org/2011/05/13/secret-garden/" target="_blank">Secret Garden at Qualcomm Augmented Reality Game Studio</a></h3>
